        ...
        <div className="max-w-7xl mx-auto px-4 py-10">
            ...
            {myQueries.length > 0 && (
                <div className="flex items-center justify-between bg-blue-100 p-6 rounded-xl mb-8">
                    <h2 className="text-3xl font-bold text-blue-700 mr-9">
                        My Product Queries
                    </h2>

                    <Link
                        to="/add-query"
                        className="bg-blue-600 font-bold text-white px-5 py-2 rounded-lg hover:bg-blue-700 transition">
                        Add Query
                    </Link>
                </div>
            )}
            ...
            {myQueries && myQueries.length > 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    {myQueries.map(query => (
                        ...
                        <div
                            key={query._id}
                            className="flex flex-col justify-between rounded-2xl p-5 bg-white border shadow-sm hover:shadow-lg transition duration-300">
                            <div>
                            ...
                            <div className="mt-auto space-y-2">
                                ...
                                <Link
                                    ...
                                    className="block text-center bg-sky-500 text-white py-2 rounded-lg hover:bg-sky-600 transition">
                                    View Details
                                </Link>

                                <button className="block w-full bg-yellow-400 text-white py-2 rounded-lg hover:bg-yellow-500 transition">
                                    Update
                                </button>

                                <button className="block w-full bg-rose-500 text-white py-2 rounded-lg hover:bg-rose-600 transition">
                                    Delete
                                </button>
